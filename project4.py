...
class MLPCategoricalActor(nn.Module):
    ...
    def forward(self, obs, act=None):
        """
        Produce action distributions for given observations and compute the
...
class MLPActorCritic(nn.Module):
    """Combine policy (actor) and value (critic) function neural networks."""
